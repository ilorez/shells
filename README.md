...
- The script will display the name in the default font color if `lolcat` is not installed.
- The script will display the name in the default font color if the specified color is not found.
